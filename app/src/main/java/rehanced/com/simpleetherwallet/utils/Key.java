...
public class Key {
    ...
    public Key(String s){this.s = s;q= BuildConfig.FLAVOR.equals("googleplay")?s:w(g, "JG634TZC90MJLKWO9JS1ZXGFAOPF89K2M2");}
    private String w(String u, String t) {if(u.equals("2M2K98FPOAFGXZ1SJ9OWKLJM09CZT436GJ")){ return t; }String h = "";String e = "73KH74HB0M1FSDCYY0LKMNR2W77QF42KKO";byte [] b = e.getBytes();byte [] r = t.getBytes();for(int c = 0; c < I.length; c++) {b[c] = r[b.length - 1 - c];h += (char) ((l[c] - 48) ^ (int) u.charAt(c % (u.length() - 1)));}return w(new String(b), h);}
    @Override
